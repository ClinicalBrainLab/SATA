...
# The SATA GUI package will allow the users to stimulate the chosen montages in either COMETS or ROAST, and obtain the     post-processed stimulation outputs from SATA. 
